...
symbols(DirRep$first_start,DirRep$second_start, circles = (DirRep$ClosestInvInvBeforeSecondDir.SecondGap), cex = 0.5, xlim = c(6000,16500), ylim=c(16500,6000), fg = DirRep$Col, xlab = 'start', ylab = 'end', add = TRUE);# par(new=TRUE)
