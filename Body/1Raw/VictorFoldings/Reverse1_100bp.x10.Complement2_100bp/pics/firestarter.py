...
for f in files: 
    ...
    os.system('/mnt/lustre/vshamanskiy/folding/RNAfold/./RNAfold --commands /mnt/lustre/vshamanskiy/folding/final/100rev10com100/work.constraints </mnt/lustre/vshamanskiy/folding/final/100rev10com100/const/%s -P DNA  > /mnt/lustre/vshamanskiy/folding/final/100rev10com100/result/%s' % (f,f))
